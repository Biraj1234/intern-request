            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.update', $data['row']->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ $data['row']->name }}" autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ $data['row']->email }}" autocomplete="email" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="number" class="form-control @error('age') is-invalid @enderror"
                                        name="age" value="{{ $data['row']->age }}" autocomplete="age">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea name="bio" id="bio" cols="30" rows="10"
                                        class="form-control @error('bio') is-invalid @enderror">{{ $data['row']->bio }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="old">
                                        ...
                                        <img src="{{ asset('uploads/users/' . $data['row']->image) }}"
                                            class="rounded">
                                    </div>
                                </div>
